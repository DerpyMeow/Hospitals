...
import net.derpymeow.hospitals.network.Page3ButtonMessage;
...
public class Page3Screen extends AbstractContainerScreen<Page3Menu> {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.hospitals.page_3.label_text"), 17, 7, -12829636, false);
	}
	...
	public void init() {
		...
		imagebutton_3 = new ImageButton(this.leftPos + 11, this.topPos + 131, 40, 40, 0, 0, 40, new ResourceLocation("hospitals:textures/screens/atlas/imagebutton_3.png"), 40, 80, e -> {
			if (true) {
				HospitalsMod.PACKET_HANDLER.sendToServer(new Page3ButtonMessage(1, x, y, z));
		...
		imagebutton_arrows = new ImageButton(this.leftPos + 219, this.topPos + 31, 40, 40, 0, 0, 40, new ResourceLocation("hospitals:textures/screens/atlas/imagebutton_arrows.png"), 40, 80, e -> {
			if (true) {
				HospitalsMod.PACKET_HANDLER.sendToServer(new Page3ButtonMessage(2, x, y, z));
				Page3ButtonMessage.handleButtonAction(entity, 2, x, y, z);
			}
		});
		...
		imagebutton_arrows_2 = new ImageButton(this.leftPos + 219, this.topPos + -4, 40, 40, 0, 0, 40, new ResourceLocation("hospitals:textures/screens/atlas/imagebutton_arrows_2.png"), 40, 80, e -> {
			if (true) {
				HospitalsMod.PACKET_HANDLER.sendToServer(new Page3ButtonMessage(3, x, y, z));
				Page3ButtonMessage.handleButtonAction(entity, 3, x, y, z);
			}
		});
