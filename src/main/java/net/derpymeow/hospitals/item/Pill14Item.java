...
import net.derpymeow.hospitals.procedures.Pill14ateProcedure;

import java.util.List;

public class Pill14Item extends Item {
	public Pill14Item() {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.hospitals.pill_14.description_0"));
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		Pill14ateProcedure.execute(entity);
		return retval;
	}
}
