...
public class IVKitItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.hospitals.iv_kit.description_0"));
		list.add(Component.translatable("item.hospitals.iv_kit.description_1"));
		list.add(Component.translatable("item.hospitals.iv_kit.description_2"));
	}
