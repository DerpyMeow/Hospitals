...
import net.derpymeow.hospitals.procedures.BloodTypeTesterPunchedProcedure;
...
public class BloodTypeTesterItem extends Item {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		BloodTypeTesterRightclickedProcedure.execute(world, entity, ar.getObject());
		return ar;
	}
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		BloodTypeTesterPunchedProcedure.execute(entity.level(), entity, sourceentity, itemstack);
		return retval;
	}
}