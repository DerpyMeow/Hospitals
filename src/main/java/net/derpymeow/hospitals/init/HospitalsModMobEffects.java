...
import net.derpymeow.hospitals.potion.SevereHypertensionMobEffect;
...
public class HospitalsModMobEffects {
	...
	public static final RegistryObject<MobEffect> SEVERE_HYPERTENSION = REGISTRY.register("severe_hypertension", () -> new SevereHypertensionMobEffect());
}
