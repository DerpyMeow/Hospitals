...
public class HospitalsModTabs {
	...
	public static final RegistryObject<CreativeModeTab> HOSPITALS = REGISTRY.register("hospitals",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.hospitals.hospitals")).icon(() -> new ItemStack(HospitalsModBlocks.MEDICAL_CROSS.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(HospitalsModBlocks.BORINGFLOORING.get().asItem());
				tabData.accept(HospitalsModBlocks.HIGH_GLOSS_FLOORING.get().asItem());
				tabData.accept(HospitalsModBlocks.CLASSIC_FLOORTILES.get().asItem());
				tabData.accept(HospitalsModBlocks.BABYBLUEXTILES.get().asItem());
				tabData.accept(HospitalsModBlocks.SHATTERED_WALL_TILES.get().asItem());
				...
				tabData.accept(HospitalsModBlocks.DO_NOT_ENTER_SIGN.get().asItem());
				tabData.accept(HospitalsModBlocks.PAPER_STACK.get().asItem());
				tabData.accept(HospitalsModBlocks.CHAIR.get().asItem());
				tabData.accept(HospitalsModBlocks.DOORSIGN.get().asItem());
				tabData.accept(HospitalsModItems.FORCEPS.get());
				tabData.accept(HospitalsModItems.SURGICALSCISSORS.get());
				tabData.accept(HospitalsModItems.RETRACTOR.get());
				tabData.accept(HospitalsModItems.PERCUSSIONHAMMER.get());
				tabData.accept(HospitalsModItems.SURGICALMARKER.get());
				tabData.accept(HospitalsModItems.TOURNIQUET.get());
				tabData.accept(HospitalsModItems.SCALPEL.get());
				tabData.accept(HospitalsModItems.IDCARDVARIENT_1.get());
				tabData.accept(HospitalsModItems.IDCARDVARIENT_2.get());
				...
				tabData.accept(HospitalsModBlocks.CURTAIN_MAIN_SEGMENT.get().asItem());
				tabData.accept(HospitalsModBlocks.CURTAIN_RAIL_SEGMENT.get().asItem());
				tabData.accept(HospitalsModBlocks.CURTAINRAILSEGMENTCORNER.get().asItem());
				tabData.accept(HospitalsModBlocks.CURTAINMAINSEGMENTCORNER.get().asItem());
				tabData.accept(HospitalsModBlocks.CURTAIN_RAILS_SEGMENT_EMPTY.get().asItem());
				tabData.accept(HospitalsModBlocks.CURTAINRAILSSEGMENTEMPTY_CORNER.get().asItem());
