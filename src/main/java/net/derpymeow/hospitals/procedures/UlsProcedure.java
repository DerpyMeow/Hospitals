...
public class UlsProcedure {
	...
	private static void execute(@Nullable Event event, Entity entity) {
		...
		}.hasRecipe(entity, ResourceLocation.parse("hospitals:pbr_0")))) {
			if (entity instanceof ServerPlayer _player) {
				Advancement _adv = _player.server.getAdvancements().getAdvancement(ResourceLocation.parse("hospitals:hosptials_gettingstarted"));
