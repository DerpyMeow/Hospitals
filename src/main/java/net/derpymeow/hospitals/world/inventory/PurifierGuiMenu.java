...
public class PurifierGuiMenu extends AbstractContainerMenu implements HospitalsModMenus.MenuAccessor {
	...
	public PurifierGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(HospitalsModMenus.PURIFIER_GUI.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 7, 35) {
			...
			private int x = PurifierGuiMenu.this.x;
			private int y = PurifierGuiMenu.this.y;
		}));
