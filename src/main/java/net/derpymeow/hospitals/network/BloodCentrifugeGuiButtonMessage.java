...
public class BloodCentrifugeGuiButtonMessage {
	...
	public BloodCentrifugeGuiButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(BloodCentrifugeGuiButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(BloodCentrifugeGuiButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
