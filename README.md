...
- 44 Unique Pills Which Come With Their Own Pill Bottle
- A Pharmacist Villager Who Has Trades For Every Single Pill
- A Pharmacy Building (Structure) Which Spawns In Plains And Snowy Plains Biomes
- Wearable Scrubs & Mask
- RP Items
- Surgical Tools
- ID Cards
- Tons of Hospital Building Blocks
- Crafting recipes for everything! (list can be found here!)
- Spawnable Nurse & Doctor NPCs That Respond To The Environment
- Blood Types 
- Blood Transfusions that heal you with effects
- Blood Collections
- Blood Processing 
- 22 page descriptive [wiki](https://derpymeow.github.io/Hospitals/hospitals-wiki.pdf)
...
**List of versions in latest release can be found [here](https://github.com/DerpyMeow/Hospitals/releases/latest)**

*(This mod will not be developed below 1.19.2, so please don't ask for it. for older versions, use the original mod!)*
...
https://discord.com/invite/JFR7e4Thrk
